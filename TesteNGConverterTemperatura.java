...
public class TesteNGConverterTemperatura {
  ...
  @Test
  public void testENGConverterTemperatura() throws Exception {
    ...
    assertEquals(driver.findElement(By.id("mensagem")).getText(), "100 Celsius = 212 Fahrenheit");
  }
